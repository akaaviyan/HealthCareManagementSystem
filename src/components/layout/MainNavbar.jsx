...
import { selectUser, logoutAction } from '../../store/authSlice';
      ...
      <Container>
        ...
        <Navbar.Collapse id="main-nav">
          <Nav className="me-auto">
            ...
            {user?.role === 'Patient' && (
              <>
                <Nav.Link as={Link} to="/patient/dashboard" onClick={close}>My Dashboard</Nav.Link>
                <Nav.Link as={Link} to="/consultations" onClick={close}>Consultation Records</Nav.Link>
                <Nav.Link as={Link} to="/patient/book-appointment" onClick={close}>Book Appointment</Nav.Link>
              </>
            )}

            {user?.role === 'Doctor' && (
              <>
                <Nav.Link as={Link} to="/doctor/dashboard" onClick={close}>My Dashboard</Nav.Link>
                <Nav.Link as={Link} to="/doctor/availability" onClick={close}>Manage Availability</Nav.Link>
              </>
            )}
          </Nav>
