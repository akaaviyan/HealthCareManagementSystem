            ...
            <Card.Body>
              ...
              {loadingDocs ? (
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  {/* Step 1 — Doctor select: stays inside card on all screens */}
                  ...
                  {/* Step 2 — Date picker: constrained to card width, no bleed */}
                  {selectedDoctorId && (
                    <Form.Group className="mb-4">
                      <Form.Label className="fw-bold">2. Select Date</Form.Label>
                      {/*
                        KEY FIX: overflow:hidden on the wrapper clips the native
                        date-picker flyout on Android/Chrome. The input itself
                        has max-width:100% from index.css so it never overflows.
                      */}
                  ...
                  {/* Step 3 — Time slots: CSS grid so they wrap & stay inside card */}
